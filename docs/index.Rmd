...
comparison_chart
```
>The comparison chart is generated using jail population rate data of King County (the county with the highest jail population rate at a specific point) from 2010 to 2018 (data of other time period is missing). The graphic is included to demonstrate the difference of jail population rate between a specific race and the total one. The pattern shown from this chart is that while the Black people, white people, and Latinx people have the jail population rate higher than the total jail population rate, Black people have the largest jail population rate difference with the total one. These racial disparities may reflect a system that treats Black people more harshly than others. 
